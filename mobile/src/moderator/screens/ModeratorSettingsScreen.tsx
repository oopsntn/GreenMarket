...
const ModeratorSettingsScreen = ({ navigation }: any) => {
    ...
    >
      <ScrollView style={styles.container}>
        ...
        <View style={styles.section}>
          <View style={styles.userInfo}>
            ...
            <View style={styles.userDetails}>
              <Text style={styles.userName}>{user?.userDisplayName || 'Moderator'}</Text>
        ...
        <View style={[styles.section, styles.footer]}>
          <Text style={styles.appVersion}>GreenMarket Moderator v1.0.0</Text>
...
export default ModeratorSettingsScreen;
