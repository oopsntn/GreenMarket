...
const ShopModerationDetail = ({ route, navigation }: any) => {
  ...
  const fetchShop = async () => {
    try {
      setLoading(true);
      const data = await ModeratorService.getShopById(shopId);
      setShop(data);
    } catch (error) {
      console.error(error);
  ...
  const handleVerify = () => {
    CustomAlert('Verify Shop', 'Approve profile and allow shop to operate on the system?', [
      ...
      { 
        ...
        onPress: async () => {
          try {
            await ModeratorService.verifyShop(shopId);
  ...
  const handleReject = () => {
    CustomAlert('Reject Profile', 'Request shop or update profile information?', [
      ...
      { 
        ...
        onPress: async () => {
          try {
            await ModeratorService.updateShopStatus(shopId, 'Rejected');
...
export default ShopModerationDetail;
