...
export const postPromotions = pgTable("post_promotions", {
    ...
    postPromotionPackageId: integer("post_promotion_package_id").references(() => promotionPackages.promotionPackageId, { onDelete: "restrict" }).notNull(),
    postPromotionSlotId: integer("post_promotion_slot_id").references(() => placementSlots.placementSlotId, { onDelete: "cascade" }).notNull(),
    postPromotionSnapshotTitle: varchar("post_promotion_snapshot_title", { length: 255 }),
    postPromotionSnapshotPriority: integer("post_promotion_snapshot_priority"),
