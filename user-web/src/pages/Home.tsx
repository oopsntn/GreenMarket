      ...
      <div className="p-4">
        ...
        <div className="flex justify-between items-end">
          <p className="text-emerald-500 font-black text-lg">
            {Number(post.postPrice).toLocaleString()} <span className="text-[10px] font-medium text-slate-500 ml-1">VND</span>
          </p>
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <header className="mb-16 text-center">
        ...
        <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-10">
          Nơi kết nối nhà vườn và người yêu cây cảnh trên toàn quốc.
        </p>
